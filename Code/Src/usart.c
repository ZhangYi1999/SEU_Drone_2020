...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART8_MspInit 0 */
    ...
    PE0     ------> UART8_RX 
    */
    GPIO_InitStruct.Pin = GYRO_TX_Pin|GYRO_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB6     ------> USART1_TX 
    */
    GPIO_InitStruct.Pin = DR16_RX_Pin|GPIO_PIN_6;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PD8     ------> USART3_TX 
    */
    GPIO_InitStruct.Pin = Judge_RX_Pin|Judge_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE0     ------> UART8_RX 
    */
    HAL_GPIO_DeInit(GPIOE, GYRO_TX_Pin|GYRO_RX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX 
    */
    HAL_GPIO_DeInit(GPIOB, DR16_RX_Pin|GPIO_PIN_6);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD8     ------> USART3_TX 
    */
    HAL_GPIO_DeInit(GPIOD, Judge_RX_Pin|Judge_TX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PG9     ------> USART6_RX 
    */
    HAL_GPIO_DeInit(GPIOG, JetsonTX2_TX_Pin|JetsonTX2_RX_Pin);
